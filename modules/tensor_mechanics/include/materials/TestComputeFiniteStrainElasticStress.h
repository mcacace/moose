...
/**
 * TestComputeFiniteStrainElasticStress computes the stress following elasticity
 * theory for finite strains
 */
class TestComputeFiniteStrainElasticStress : public ComputeStressBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  TestComputeFiniteStrainElasticStress(const InputParameters & parameters);
