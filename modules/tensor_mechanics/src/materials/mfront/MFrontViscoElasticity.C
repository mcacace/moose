...
registerMooseObject("TensorMechanicsApp", MFrontViscoElasticity);

InputParameters
MFrontViscoElasticity::validParams()
{
  InputParameters params = MFrontStressBase::validParams();
  params.addClassDescription("mfront model - Maxwell viscoelasticity.");
...
MFrontViscoElasticity::MFrontViscoElasticity(const InputParameters & parameters)
...
void
MFrontViscoElasticity::setMaterialProperties(mgis::behaviour::BehaviourData & bd)
{
...
void
MFrontViscoElasticity::setInternalStateVariables(mgis::behaviour::BehaviourData & bd)
{
...
void
MFrontViscoElasticity::setExternalStateVariables(mgis::behaviour::BehaviourData & bd)
{
...
void
MFrontViscoElasticity::updateStateFromMFront(mgis::behaviour::BehaviourData & bd)
{
...
void
MFrontViscoElasticity::computeEffectiveViscosity()
{
