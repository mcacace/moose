...
#include "TestComputeFiniteStrainElasticStress.h"

registerMooseObject("TensorMechanicsApp", TestComputeFiniteStrainElasticStress);

InputParameters
TestComputeFiniteStrainElasticStress::validParams()
{
...
TestComputeFiniteStrainElasticStress::TestComputeFiniteStrainElasticStress(
...
void
TestComputeFiniteStrainElasticStress::initialSetup()
{
}

void
TestComputeFiniteStrainElasticStress::initQpStatefulProperties()
{
...
void
TestComputeFiniteStrainElasticStress::computeQpStress()
{
