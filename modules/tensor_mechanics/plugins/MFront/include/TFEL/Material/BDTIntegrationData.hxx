/*!
* \file   TFEL/Material/BDTIntegrationData.hxx
* \brief  this file implements the BDTIntegrationData class.
*         File generated by tfel version 4.0.0-dev
 */

#ifndef LIB_TFELMATERIAL_BDT_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_BDT_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const BDTIntegrationData<hypothesis, NumericType, false>&);

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
class BDTIntegrationData<hypothesis, NumericType, false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const BDTIntegrationData&);
...
*/
BDTIntegrationData(const BDTIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
BDTIntegrationData(const mfront::gb::BehaviourData& mgb_d)
: dt(mgb_d.dt),
...
BDTIntegrationData&
>::type
scale(const BDTBehaviourData<hypothesis, NumericType, false>&, const Scal time_scaling_factor){
...
*/
BDTIntegrationData&
updateDrivingVariables(const BDTBehaviourData<hypothesis, NumericType, false>&){
return *this;
}

}; // end of BDTIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType>
std::ostream&
operator <<(std::ostream& os,const BDTIntegrationData<hypothesis, NumericType, false>& b)
{
os << "Δεᵗᵒ : " << b.deto << '\n';
os << "σ : " << b.sig << '\n';
os << "Δt : " << b.dt << '\n';
...
#endif /* LIB_TFELMATERIAL_BDT_INTEGRATION_DATA_HXX */
