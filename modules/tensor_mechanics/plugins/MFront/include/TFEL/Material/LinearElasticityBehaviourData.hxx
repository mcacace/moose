/*!
* \file   TFEL/Material/LinearElasticityBehaviourData.hxx
* \brief  this file implements the LinearElasticityBehaviourData class.
*         File generated by tfel version 4.0.0-dev
* \author Helfer Thomas
* \date   23 / 11 / 06
 */

#ifndef LIB_TFELMATERIAL_LINEARELASTICITY_BEHAVIOUR_DATA_HXX
#define LIB_TFELMATERIAL_LINEARELASTICITY_BEHAVIOUR_DATA_HXX
...
class LinearElasticityBehaviourData;
...
template<ModellingHypothesis::Hypothesis hypothesis, typename NumericType, bool use_qt>
std::ostream&
 operator <<(std::ostream&,const LinearElasticityBehaviourData<hypothesis, NumericType, use_qt>&);
...
friend std::ostream& operator<< <>(std::ostream&,const LinearElasticityBehaviourData&);

/* integration data is declared friend to access   driving variables at the beginning of the time step */
friend class LinearElasticityIntegrationData<hypothesis, NumericType, use_qt>;
...
#line 11 "LinearElasticity.mfront"
stress young;
#line 13 "LinearElasticity.mfront"
real nu;
...
*/
LinearElasticityBehaviourData()
{}

/*!
* \brief copy constructor
*/
LinearElasticityBehaviourData(const LinearElasticityBehaviourData& src)
: eto(src.eto),
sig(src.sig),
young(src.young),
nu(src.nu),
 ...
 */
LinearElasticityBehaviourData(const mfront::gb::BehaviourData& mgb_d)
...
*/
LinearElasticityBehaviourData&
operator=(const LinearElasticityBehaviourData& src){
this->eto = src.eto;
this->sig = src.sig;
...
}; // end of LinearElasticityBehaviourDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename NumericType, bool use_qt>
std::ostream&
operator <<(std::ostream& os,const LinearElasticityBehaviourData<hypothesis, NumericType, use_qt>& b)
{
os << "εᵗᵒ : " << b.eto << '\n';
os << "σ : " << b.sig << '\n';
os << "young : " << b.young << '\n';
...
#endif /* LIB_TFELMATERIAL_LINEARELASTICITY_BEHAVIOUR_DATA_HXX */
